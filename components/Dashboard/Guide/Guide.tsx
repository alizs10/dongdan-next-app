        ...
        <div className="events_container">
            <div className="event_header_container">
                ...
                <div className="event_header_right">
                    ...
                    <h1 className="event_header_title">راهنمای استفاده</h1>
                </div>
            </div>
            ...
            <div className='py-5 px-5 flex flex-col gap-y-6'>
                ...
                <p className='text-base md:text-lg lg:text-xl text-gray-700 dark:text-gray-300 font-semibold'>1- برای ایجاد یک رویداد جدید مسیر زیر رو دنبال میکنی:</p>
                <div className="flex flex-wrap items-center gap-2 text-gray-500 dark:text-gray-400 mx-auto px-10 lg:px-5 py-5 lg:py-2 rounded-full border border-gray-300 dark:border-gray-700">
                    <span className='text-sm md:text-base lg:text-lg'>منوی دسترسی سریع</span>
                    <MoveLeft className='size-5 text-gray-300 dark:text-gray-700' />
                ...
                <p className='text-base md:text-lg lg:text-xl text-gray-700 dark:text-gray-300 font-semibold'>2- فرم ایجاد رویداد را با اطلاعات زیر تکمیل میکنی:</p>
                <div className="flex flex-wrap items-center gap-2 text-gray-500 dark:text-gray-400 mx-auto px-10 lg:px-5 py-5 lg:py-2 rounded-full border border-gray-300 dark:border-gray-700">
                ...
                <p className='text-base md:text-lg lg:text-xl text-gray-700 dark:text-gray-300 font-semibold'>برای حذف یا ویرایش یک رویداد، از لیست رویداد ها رویداد مورد نظر را پیدا کن و روی دکمه سه نقطه کلیک کن:</p>
                <div className="flex flex-wrap items-center gap-2 text-gray-500 dark:text-gray-400 mx-auto px-10 lg:px-5 py-5 lg:py-2 rounded-full border border-gray-300 dark:border-gray-700">
                    <span className='text-sm md:text-base lg:text-lg'>منوی دسترسی سریع</span>
                    <MoveLeft className='size-5 text-gray-300 dark:text-gray-700' />
                    <span className='text-sm md:text-base lg:text-lg'>رویداد ها</span>
                ...
                <p className='text-base md:text-lg lg:text-xl text-gray-700 dark:text-gray-300 font-semibold'>برای مشاهده یک رویداد، از لیست رویداد ها رویداد مورد نظر را پیدا کن و روی دکمه مشاهده جزییات کلیک کن:</p>
                <div className="flex flex-wrap items-center gap-2 text-gray-500 dark:text-gray-400 mx-auto px-10 lg:px-5 py-5 lg:py-2 rounded-full border border-gray-300 dark:border-gray-700">
                    <span className='text-sm md:text-base lg:text-lg'>منوی دسترسی سریع</span>
                    <MoveLeft className='size-5 text-gray-300 dark:text-gray-700' />
                    <span className='text-sm md:text-base lg:text-lg'>رویداد ها</span>
                ...
                <p className='text-base md:text-lg lg:text-xl text-gray-700 dark:text-gray-300 font-semibold'>1- پس از ساخت رویداد جدید، ابتدا باید اعضای گروه آن را تعریف کرد. برای این منظور به صورت زیر عمل میکنیم:</p>
                <div className="flex flex-wrap items-center gap-2 text-gray-500 dark:text-gray-400 mx-auto px-10 lg:px-5 py-5 lg:py-2 rounded-full border border-gray-300 dark:border-gray-700">
                ...
                <p className='text-base md:text-lg lg:text-xl text-gray-700 dark:text-gray-300 font-semibold'>1.1- در ادامه فرم عضو جدید را با اطلاعات زیر تکمیل میکنیم:</p>
                <div className="flex flex-wrap items-center gap-2 text-gray-500 dark:text-gray-400 mx-auto px-10 lg:px-5 py-5 lg:py-2 rounded-full border border-gray-300 dark:border-gray-700">
                ...
                <p className='text-base md:text-lg lg:text-xl text-gray-700 dark:text-gray-300 font-semibold'>برای حذف یا ویرایش یک شخص از گروه، از صفحه رویداد و منوی سمت راست، اعضای گروه را پیدا میکنیم و بصورت زیر عمل میکنیم:</p>
                <div className="flex flex-wrap items-center gap-2 text-gray-500 dark:text-gray-400 mx-auto px-10 lg:px-5 py-5 lg:py-2 rounded-full border border-gray-300 dark:border-gray-700">
                ...
                <p className='text-base md:text-lg lg:text-xl text-gray-700 dark:text-gray-300 font-semibold'>پس از ساخت رویداد و تعریف اعضای گروه، سومین قدم ثبت هزینه ها یا جابجایی های پولی است. هزینه، مقدار پولی است که یک شخص برای گروه هزینه کرده است. جابجایی پول هم به معنی انتقال پول بین دو نفر از اعضا می باشد.</p>
                ...
                <p className='text-base md:text-lg lg:text-xl text-gray-700 dark:text-gray-300 font-semibold'>برای حذف یا ویرایش هزینه/جابجایی پول، از صفحه رویداد و لیست هزینه ها، هزینه/جابجایی پول مورد نظر را پیدا میکنیم و بصورت زیر عمل میکنیم:</p>
                <div className="flex flex-wrap items-center gap-2 text-gray-500 dark:text-gray-400 mx-auto px-10 lg:px-5 py-5 lg:py-2 rounded-full border border-gray-300 dark:border-gray-700">
                    <span className='text-sm md:text-base lg:text-lg'>در صفحه رویداد</span>
                    <MoveLeft className='size-5 text-gray-300 dark:text-gray-700' />
                ...
                <p className='text-base md:text-lg lg:text-xl text-gray-700 dark:text-gray-300 font-semibold'>فیلتر هزینه ها شامل نوع هزینه، حداقل و حداکثر مبلغ، بازه ی تاریخی و افراد گروه می باشد.</p>
                <div className="flex flex-wrap items-center gap-2 text-gray-500 dark:text-gray-400 mx-auto px-10 lg:px-5 py-5 lg:py-2 rounded-full border border-gray-300 dark:border-gray-700">
                    <span className='text-sm md:text-base lg:text-lg'>در صفحه رویداد</span>
                    <MoveLeft className='size-5 text-gray-300 dark:text-gray-700' />
                    <span className='text-sm md:text-base lg:text-lg'>از سربرگ</span>
                ...
                <p className='text-base md:text-lg lg:text-xl text-gray-700 dark:text-gray-300 font-semibold'>در صفحه رویداد و منوی سمت راست آن، بخشی با عنوان اطلاعات رویداد وجود دارد که اطلاعات جامع رویداد را به شما نشان خواهد داد. همچنین در این بخش میتوانید مشخص کنید که رویداد شما به پایان رسیده یا در جریان است.</p>
                <div className="flex flex-wrap items-center gap-2 text-gray-500 dark:text-gray-400 mx-auto px-10 lg:px-5 py-5 lg:py-2 rounded-full border border-gray-300 dark:border-gray-700">
                    <span className='text-sm md:text-base lg:text-lg'>در صفحه رویداد</span>
                    <MoveLeft className='size-5 text-gray-300 dark:text-gray-700' />
                    <span className='text-sm md:text-base lg:text-lg'>از منوی سمت راست</span>
                ...
                <p className='text-base md:text-lg lg:text-xl text-gray-700 dark:text-gray-300 font-semibold'>در صفحه رویداد و منوی سمت راست میتوانید محاسبات مربوط به رویداد را در قسمت محاسبات مشاهده کنید.</p>
                <div className="flex flex-wrap items-center gap-2 text-gray-500 dark:text-gray-400 mx-auto px-10 lg:px-5 py-5 lg:py-2 rounded-full border border-gray-300 dark:border-gray-700">
                    <span className='text-sm md:text-base lg:text-lg'>در صفحه رویداد</span>
                    <MoveLeft className='size-5 text-gray-300 dark:text-gray-700' />
                    <span className='text-sm md:text-base lg:text-lg'>از منوی سمت راست</span>
                ...
                <p className='text-base md:text-lg lg:text-xl text-gray-700 dark:text-gray-300 font-semibold'>برای بهبود تجربه کاربری و سهولت استفاده، یکبار دوستان خود را ثبت کنید تا در هنگام ساخت رویدادهایتان بتوانید آن ها را به سرعت و راحتی در رویداد مشارکت دهید.</p>
                <div className="flex flex-wrap items-center gap-2 text-gray-500 dark:text-gray-400 mx-auto px-10 lg:px-5 py-5 lg:py-2 rounded-full border border-gray-300 dark:border-gray-700">
                    <span className='text-sm md:text-base lg:text-lg'>منوی دسترسی سریع</span>
                    <MoveLeft className='size-5 text-gray-300 dark:text-gray-700' />
                ...
                <p className='text-base md:text-lg lg:text-xl text-gray-700 dark:text-gray-300 font-semibold'>1- برای ساخت دوست جدید به روش زیر عمل میکنیم:</p>
                <div className="flex flex-wrap items-center gap-2 text-gray-500 dark:text-gray-400 mx-auto px-10 lg:px-5 py-5 lg:py-2 rounded-full border border-gray-300 dark:border-gray-700">
                    <span className='text-sm md:text-base lg:text-lg'>منوی دسترسی سریع</span>
                    <MoveLeft className='size-5 text-gray-300 dark:text-gray-700' />
                    <span className='text-sm md:text-base lg:text-lg'>دوستان</span>
                ...
                <p className='text-base md:text-lg lg:text-xl text-gray-700 dark:text-gray-300 font-semibold'>2- فرم افزودن دوست را با اطلاعات زیر تکمیل میکنیم:</p>
                <div className="flex flex-wrap items-center gap-2 text-gray-500 dark:text-gray-400 mx-auto px-10 lg:px-5 py-5 lg:py-2 rounded-full border border-gray-300 dark:border-gray-700">
                ...
                <p className='text-base md:text-lg lg:text-xl text-gray-700 dark:text-gray-300 font-semibold'>برای حذف یا ویرایش یک دوست، از لیست دوستان شخص مورد نظر را پیدا میکنیم و روی دکمه سه نقطه کلیک میکنیم:</p>
                <div className="flex flex-wrap items-center gap-2 text-gray-500 dark:text-gray-400 mx-auto px-10 lg:px-5 py-5 lg:py-2 rounded-full border border-gray-300 dark:border-gray-700">
                    <span className='text-sm md:text-base lg:text-lg'>منوی دسترسی سریع</span>
                    <MoveLeft className='size-5 text-gray-300 dark:text-gray-700' />
                    <span className='text-sm md:text-base lg:text-lg'>دوستان</span>
                ...
                <p className='text-base md:text-lg lg:text-xl text-gray-700 dark:text-gray-300 font-semibold'>به منظور حفظ داده های کاربر، رویداد ها و دوستان شما پس از حذف کاملا حذف نمی شوند و فقط به سطل زباله منتقل می شوند. برای حذف دائمی آن ها کافیست به سطل زباله رفته و آن ها را حذف دائم کنید یا اینکه آن ها را بازیابی کنید.</p>
                ...
                <p className='text-base md:text-lg lg:text-xl text-gray-700 dark:text-gray-300 font-semibold'>برای دسترسی به سطل زباله رویداد ها کافی ست ابتدا به بخش رویداد ها رفته سپس از منوی سریع سطل زباله را انتخاب کنید.</p>
                <div className="flex flex-wrap items-center gap-2 text-gray-500 dark:text-gray-400 mx-auto px-10 lg:px-5 py-5 lg:py-2 rounded-full border border-gray-300 dark:border-gray-700">
                    <span className='text-sm md:text-base lg:text-lg'>منوی دسترسی سریع</span>
                    <MoveLeft className='size-5 text-gray-300 dark:text-gray-700' />
                    <span className='text-sm md:text-base lg:text-lg'>رویداد ها</span>
                ...
                <p className='text-base md:text-lg lg:text-xl text-gray-700 dark:text-gray-300 font-semibold'>برای دسترسی به سطل زباله دوستان کافی ست ابتدا به بخش دوستان رفته سپس از منوی سریع سطل زباله را انتخاب کنید.</p>
                <div className="flex flex-wrap items-center gap-2 text-gray-500 dark:text-gray-400 mx-auto px-10 lg:px-5 py-5 lg:py-2 rounded-full border border-gray-300 dark:border-gray-700">
                    <span className='text-sm md:text-base lg:text-lg'>منوی دسترسی سریع</span>
                    <MoveLeft className='size-5 text-gray-300 dark:text-gray-700' />
                    <span className='text-sm md:text-base lg:text-lg'>دوستان</span>
                ...
                <p className='text-base md:text-lg lg:text-xl text-gray-700 dark:text-gray-300 font-semibold'>برای بازیابی یا حذف دائم رویداد/دوست، کافی ست از سطل زباله مربوط به هرکدام اقدام کنید.</p>
                <div className="flex flex-wrap items-center gap-2 text-gray-500 dark:text-gray-400 mx-auto px-10 lg:px-5 py-5 lg:py-2 rounded-full border border-gray-300 dark:border-gray-700">
                    <span className='text-sm md:text-base lg:text-lg'>منوی دسترسی سریع</span>
                    <MoveLeft className='size-5 text-gray-300 dark:text-gray-700' />
