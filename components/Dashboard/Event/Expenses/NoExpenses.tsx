...
function NoExpenses({ openNewExpenseModal, eventStatus, isDeleted, isFilterMode }: { openNewExpenseModal: () => void, eventStatus: Event['status'], isDeleted: boolean, isFilterMode: boolean }) {
    return (
